...
<head>
  <title>فروشگاه دات نت کسما</title>
  <meta http-equiv="Content-Type" content="text/html; charset=windows-1252" />
  <link rel="stylesheet" type="text/css" href="style.css" />
  <link rel="stylesheet" type="text/css" href="Fonts.css" />
  <link rel="icon" type="image/x-icon" href="images/icon/nikian.png" />
  <!--[if IE 6]>
...
<body>
  <div id="main_container">
    ...
    <div id="main_content">
      <div id="menu_tab">
        <ul class="menu">
          <li><a href="#" class="nav">صفحه ی اصلی </a></li>
          <li class="divider"></li>
          <li><a href="#" class="nav">ابزار های بادی</a></li>
          <li class="divider"></li>
          <li><a href="#" class="nav">ابزار های تجاری</a></li>
          <li class="divider"></li>
          <li><a href="#" class="nav">ابزار های آهنگری</a></li>
          <li class="divider"></li>
          <li><a href="#" class="nav">ابزار های نقاشی</a></li>
          <li class="divider"></li>
          <li><a href="#" class="nav">ابزار های دستی</a></li>
          <li class="divider"></li>
          <li><a href="contact.html" class="nav">درباره ما</a></li>
          <li class="divider"></li>
          <li><a href="details.html" class="nav">ارتباط با ما</a></li>
        </ul>
      </div>
      <!-- end of menu tab -->
      ...
      <div class="center_content">
        <div class="oferta"> <img src="images/p1.png" width="165" height="113" border="0" class="oferta_img" alt="" />
          <div class="oferta_details">
            ...
            <div class="oferta_text"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor
      ...
      <div class="right_content">
        <div class="title_box">جستجو</div>
        <div class="border_box">
          <input type="text" name="newsletter" class="newsletter_input" value="keyword" />
          <a href="#" class="join">searchhhhs</a>
        </div>
    ...
    <div class="footer">
      ...
      <div class="center_footer"> Template name. All Rights Reserved 2008<br />
        <a href="http://csscreme.com"><img src="images/csscreme.jpg" alt="csscreme" title="csscreme"
            border="0" /></a><br />
